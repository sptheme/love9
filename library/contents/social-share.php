<div class="sharrre-container clearfix">
	<span><?php _e('Share', SP_TEXT_DOMAIN); ?></span>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		...
		jQuery('#facebook').sharrre({
			...
			template: '<a class="box" href="#"><div class="count" href="#">{total}</div><div class="share"><i class="icon-facebook-squared"></i></div></a>',
			enableHover: false,
			enableTracking: true,
			click: function(api, options){
				api.simulateClick();
		...
		jQuery('#googleplus').sharrre({
			...
			template: '<a class="box" href="#"><div class="count" href="#">{total}</div><div class="share"><i class="icon-gplus"></i></div></a>',
			enableHover: false,
			enableTracking: true,
			urlCurl: '<?php echo get_template_directory_uri() .'/assets/js/sharrre.php'; ?>',
			click: function(api, options){
				api.simulateClick();
		...
		jQuery('#pinterest').sharrre({
			...
			template: '<a class="box" href="#" rel="nofollow"><div class="count" href="#">{total}</div><div class="share"><i class="icon-pinterest"></i></div></a>',
			enableHover: false,
			enableTracking: true,
			buttons: {
			pinterest: {
